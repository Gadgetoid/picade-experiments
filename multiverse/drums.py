...
PLAYER_MAP = [
    # Player / Button
    # Right Controls
    [1, 7, "drums/Toms/Tom Low/Acoustic Low Tom 01.wav"],
    [1, 5, "drums/Toms/Tom Mid/Acoustic Mid Tom 01.wav"],
    [1, 6, "drums/Toms/Tom High/Acoustic High Tom 01.wav"],
    [1, 1, "drums/Snare/Acoustic Snare 03.wav"],
    [1, 2, "drums/Cymbals/Ride/Damped/Acoustic Ride Damped 10.wav"],
    [1, 3, "drums/Snare/Acoustic Snare Ring 09.wav"],
    [1, 0, "drums/Kick/Acoustic Kick 23.wav"],
    # Left Controls
